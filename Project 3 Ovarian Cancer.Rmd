...
# ja lass des mal drin ich hab des für den nächsten step der PCA benutzt... also die kd.prob.topVar  mfG Marco


```
Performing Principal Component Analysis

To reduce the information of the kd.ceres matrix we perform a PCA. The Analysis creates groups of cell lines with similar lethality partners. We use the variable TopVar created before.
...
#to add the right colors to that legend we create a new dataframe containing the colors and the categories used in step 4:
