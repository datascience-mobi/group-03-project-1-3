...
#neue Matrix belegen, damit expression nicht ?berschribene wird
...
remove(exp1, cn1)
```
A Create a scatter to check the correlation between the two variables and correlation coefficient in the plot is ablined (sieht nicht so gut aus, was kann ich ?ndern :( )
```{r}
