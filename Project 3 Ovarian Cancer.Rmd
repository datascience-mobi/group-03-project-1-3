...
for (j in 0:2000) {   #!!!!!!! hier bevor ihrs abgebt 10000 eintragen, dauert dann nur bissl l‰nger zu knitten!!!!!
  ...
  for(i in 1:5) {
    ...
    #we don't need groups that contain only one or two cell lines because the mutations would not be significant
    if (NCOL(kp) > 1) { 
