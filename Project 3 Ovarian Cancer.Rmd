...
diffARID1A <- diffARID1A[order(diffARID1A$Difference, decreasing = TRUE),] # warum bei view auf einmal NA values? bei Marco hats doch auch geklappt
barplot(diffARID1A$Difference, names.arg = rownames(diffARID1A), xlab="SL partner", las = 1, horiz=FALSE, cex.axis = 1,2, col = "lightblue", main = "SL partners for ARID1A mutation", ylab = "difference in essentiality") # funktioniert, aber noch mal gucken ob das wirklich sein kann. Erscheint mit irgendwie viel. Wie mach ich hier, dass unten die Gennamen angezeigt werden?
